...
one. With more time, I would have investigated why scheduler_bias_flipped is being set and the intended order. I would then 
check whether changing the order removes THERM_STALE.
